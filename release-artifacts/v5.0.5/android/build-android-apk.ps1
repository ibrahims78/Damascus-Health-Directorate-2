...
#   powershell -ExecutionPolicy Bypass -File release-artifacts/v5.0.5/android/build-android-apk.ps1

$ErrorActionPreference = 'Stop'
$root = Split-Path -Parent (Split-Path -Parent $PSScriptRoot)
$releaseDir = Join-Path $root 'release-artifacts\v5.0.5'
...
$env:DAMASCUS_RELEASE_VERSION = 'v5.0.5'
...
Build-Apk `
  ...
  -OutputName 'Damascus-Health-Directorate-v5.0.5-Android-Protected.apk'
...
Build-Apk `
  ...
  -OutputName 'Damascus-Health-Directorate-v5.0.5-Android-Offline.apk'
