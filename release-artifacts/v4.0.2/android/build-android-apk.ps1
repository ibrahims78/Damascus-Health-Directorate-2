# build-android-apk.ps1 — build the offline Android APKs (normal + protected)
...
#   powershell -ExecutionPolicy Bypass -File release-artifacts/v4.0.2/android/build-android-apk.ps1

$ErrorActionPreference = 'Stop'
$root = Split-Path -Parent (Split-Path -Parent $PSScriptRoot)
$releaseDir = Join-Path $root 'release-artifacts\v4.0.2'
...
$env:DAMASCUS_RELEASE_VERSION = 'v4.0.2'
...
Build-Apk `
  ...
  -OutputName 'Damascus-Emergency-Inventory-v4.0.2-Android-Protected.apk'
...
Build-Apk `
  ...
  -OutputName 'Damascus-Emergency-Inventory-v4.0.2-Android-Offline.apk'
